...
TASK_LORA_SHA256 = "44377e4efaf12d6358cd5df75e9dc4a9af125e8c58dc1fe4245fe3cd37417e90"
CONTEXTUAL_CORRECTION_SHA256 = "9a4103957b60888b403dff784e2c8c9904f63ce528341a352fbfad8800c46a5e"
...
task_lora = _load_locked("task_lora_model_for_final_student", TASK_LORA_MODEL, TASK_LORA_SHA256)
contextual_correction = _load_locked("contextual_correction_model_for_final_student", CONTEXTUAL_CORRECTION_MODEL, CONTEXTUAL_CORRECTION_SHA256)

TaskPrivateLoRALinear = task_lora.TaskPrivateLoRALinear
ContextualTaskResidualHead = contextual_correction.ContextualTaskResidualHead
frozen_anchor_state_sha256 = task_lora.frozen_anchor_state_sha256
_sha256_tensors = task_lora._sha256_tensors


class DecoupledTaskPrivateFoundationCorrection(nn.Module):
    """Frozen FusedTeacher anchor plus an independently scaled task-private correction.

    The locked FusedTeacher task scale defines only ``anchor_logits``. The new USFM
