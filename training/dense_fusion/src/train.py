...
TRAINER_SOURCE = PROJECT_ROOT / "2-code/157-active-vertical-exp152-5fold/src/train_exp157.py"
...
def _load_trainer():
    ...
    name = "exp157_trainer_for_exp191"
...
trainer.exp148_model = local_model
    ...
    sources.update(
        {
            ...
            PROJECT_ROOT / "2-code/184-usfm-task-private-vitpose/src/model.py",
            PROJECT_ROOT / "2-code/184-usfm-task-private-vitpose/src/usfm_backbone.py",
