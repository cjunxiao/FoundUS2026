...
def build_network(task_configs: list[dict[str, Any]]) -> Exp301Network:
    ...
    return Exp301Network(task_configs)
...
class Model:
    def __init__(self):
        ...
        print(
            f"Loaded Exp301 final model on {self.device}; checkpoint={actual_hash}",
            flush=True,
        )
    ...
    def predict(self, data_root: str, output_dir: str, batch_size: int = 8):
        ...
        # The validated Exp301 prediction path used homogeneous task batches of four.
